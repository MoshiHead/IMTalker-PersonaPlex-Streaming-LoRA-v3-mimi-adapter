...
def make_engine_args(output_dir: Path, ref_path: str) -> argparse.Namespace:
    argv = [
        ...
        "--lora_path", "/workspace/IMTalker-PersonaPlex-Streaming-v1/IMTalker/checkpoints/lora.ckpt",
        "--lora_rank", "64",
        "--lora_alpha", "128",
...
def main() -> None:
    ...
    ap.add_argument("--session_dir", default="/workspace/IMTalker-PersonaPlex-Streaming-v1/IMTalker/live_try_dumps_personaplex_frontend_source5_cfg134/last_session")
    ap.add_argument("--ref_path", default="/workspace/IMTalker-PersonaPlex-Streaming-v1/IMTalker/assets/source_5.png")
    ap.add_argument("--output_dir", default="/workspace/IMTalker-PersonaPlex-Streaming-v1/IMTalker/offline_from_live_helium_last_session")
