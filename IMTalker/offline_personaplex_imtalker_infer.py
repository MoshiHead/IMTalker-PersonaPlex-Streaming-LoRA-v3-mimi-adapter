...
def main() -> None:
    ...
    ap.add_argument("--input_audio", default="/workspace/IMTalker-PersonaPlex-Streaming-v1/IMTalker/assets/audio_3.wav")
    ap.add_argument("--ref_path", default="/workspace/IMTalker-PersonaPlex-Streaming-v1/IMTalker/assets/source_5.png")
    ap.add_argument("--output_dir", default="/workspace/IMTalker-PersonaPlex-Streaming-v1/IMTalker/offline_personaplex_imtalker_audio3")
